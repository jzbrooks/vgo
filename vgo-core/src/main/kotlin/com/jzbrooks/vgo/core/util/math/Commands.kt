...
fun computeAbsoluteCoordinates(commands: List<Command>): Float2 {
    ...
    for (i in commands.indices) {
        ...
        val newCurrentPoint = when (command) {
            ...
            is HorizontalLineTo -> Float2(command.parameters[0], 0f)
            is VerticalLineTo -> Float2(0f, command.parameters[0])
